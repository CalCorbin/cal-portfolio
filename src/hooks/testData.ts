...
export const mockGarageSalesResponse: GarageSalesResponse = {
  ...
  Records: [
    // [Object_ID, Address, Zipcode, Permit_Date, Applicances, Baby_Kid_Items,
    //  Clothing, Electronics, Entertainment, Fitness_Equipment, Furniture,
    //  Hobbies, Kitchen_Items, Lawn_Tools, Household_Items, Sporting_Goods,
    //  All_Categories, Shape]
    ['1', '123 Main St', '73102', '2024-06-01', 'Yes', 'No', 'Yes', 'No',
     'Yes', 'No', 'Yes', 'No', 'Yes', 'No', 'Yes', 'No',
     'Clothing, Furniture, Kitchen Items', '35.4676,-97.5164,19'],
  ],
};
